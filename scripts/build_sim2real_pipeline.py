...
def main() -> None:
    ...
    parser.add_argument("--stationary-noise", type=Path)
    parser.add_argument("--hardware-latency", type=Path)
    parser.add_argument("--calibration-quality", type=Path)
    parser.add_argument("--deployment-readiness", type=Path, required=True)
    parser.add_argument("--replay-comparison", type=Path)
    parser.add_argument("--motor-bench", type=Path)
    parser.add_argument("--sensor-profile", type=Path, default=None)
    parser.add_argument("--sim-readiness", type=Path, required=True)
    parser.add_argument("--room-report", type=Path)
